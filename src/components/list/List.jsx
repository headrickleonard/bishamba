...
import { SCREEN_HEIGHT, SCREEN_WIDTH } from "../../const/window";
...
const List = () => {
  ...
  const [scrollContainerHeight, setScrollContainerHeight] = useState(SCREEN_HEIGHT);
  const listData = [
    {
      id: 1,
      title: "Amazon",
      subTitle: "Groceries",
      category: "Main Priduct",
    ...
    },
    {
      ...
      subTitle: "Groceries",
      category: "Tooling And Machinery",
      image: require(`../../assets/icons/more.png`),
      price: -85,
    },]
  const toggleList = () => {
